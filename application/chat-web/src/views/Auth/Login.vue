      ...
      <div class="bg-white px-10 py-20 rounded-3xl border-2 border-gray-200">
        ...
        <div class="mt-8">
          ...
          <div class="mt-8 flex justify-between items-center">
            ...
            <button class="font-medium text-base text-purple-500">Forgot password?</button>
          </div>
          <div class="mt-2 flex">
            <p class="mr-2 text-gray-500">Don't have an account?</p> <a href="/register"> Register Now</a>
          </div>
          <div class="mt-8 flex flex-col gap-y-4">
            <button class="hover:scale-50 py-3 rounded-xl bg-purple-500 text-white text-lg font-bold" @click.prevent="login">Sign in</button>
