...
let UserRoute = class UserRoute {
    initializeRoutes() {
        ...
        this.router.post('/users', (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto), this.user.createUser);
        this.router.put('/users/:id(\\d+)', (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto, true), this.user.updateUser);
